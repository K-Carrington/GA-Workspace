...
var isDone = "no";
while ((isDone === "no") || (isDone === "No") || (isDone === "NO")) {
	isDone = prompt("Are you done?");
}
...
var theTarget = "Random number between 1 and 101."
...
var guessed = false;
while (!guessed) {
	guess = prompt("Make a guess between 1 and 101!");
...
concatStrings("t","oes");  // output is: "toes"
...
repeatString(5, 6);  // output is: "66666"
